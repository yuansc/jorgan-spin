 ...
 * be replaced by a less intrusive solution.
 */
public class AWTReflectDispatcherFactory implements DispatcherFactory {
  ...
  private class AWTReflectDispatcher implements Dispatcher, InvocationHandler {
     ...
     * instance - called by the EventDispatchThread to test if pumping of
     * events should be continued.
     *
  ...
  /**
   * Initialize AWT internals.
   * <br>
   * Get references to class <code>java.awt.Conditional</code> and
   * method <code>java.awt.EventDispatchThread.pumpEvents()</code>.
   */
  static {
    try {
      conditionalClass = Class.forName("java.awt.Conditional");

      pumpMethod = Class.forName("java.awt.EventDispatchThread").getDeclaredMethod("pumpEvents",
