...
public class SpinOffTest extends TestCase {
    ...
    public void testEDTNotBlockedDuringInvocation() throws Exception {
        class Flag { public boolean flag1, flag2; Throwable exception; }
        ...
        assertTrue("Second runnable took too long: " + timer.elapsed(),
                   timer.elapsed() < DELAY);
        ...
        assertNull("Unexpected exception in original invocation " + flag.exception, 
                   flag.exception);
    }
}
